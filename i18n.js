...
(function () {
  const en = {
    ...
    's2.desc': 'Auto-generates an Agent chat interface and an OpenAI-compatible API. Zero deployment needed.',
    's2.foot': 'No ops — published means live',
    's3.h3': 'Share the Link',
    's3.desc': 'Showcase all your agents on your Agent Space personal toolbox — one link to share with anyone.',
    ...
    'f1.a': '<b>Agent</b>A standalone chat page — anyone with the link can chat with your agent; password protection and visit stats supported',
    ...
    'f2.a': '<b>Agent Space</b>Your personal AI toolbox, showcasing all agents like a Linktree; custom theme color, bio, and ordering',
    ...
    'dl.action2': 'Install & account setup guide <span class="arrow">→</span>',
    ...
    'dl.pl.title': 'Download for Desktop<br><span class="sec-sub">Windows and macOS are live · Linux is on the way</span>',
    'dl.pl.sub': 'Windows and macOS are live · Linux is on the way',
    'dl.pl.win.h3': 'Windows',
    'dl.pl.win.note': 'Windows 10 / 11 · x64',
    'dl.pl.win.btn': 'Download .zip',
    'dl.pl.win.foot': 'v1.1.0 · 2026-09',
    'dl.pl.lin.h3': 'Linux',
    'dl.pl.lin.note': 'Ubuntu / Debian · x64',
    'dl.pl.lin.btn': 'Coming Soon',
    'dl.pl.lin.foot': 'COMING SOON',
    'dl.pl.mac.h3': 'macOS',
    'dl.pl.mac.note': 'macOS 12+',
    'dl.pl.mac.arm64': 'Apple Silicon',
    'dl.pl.mac.intel': 'Intel',
    'dl.pl.mac.howto': 'Not sure? Apple menu → About This Mac → Chip',
    'dl.pl.mac.btn': 'Download .dmg',
    'dl.pl.mac.foot': 'v1.1.0 · 2026-09',
  ...
  const zh = {
    ...
    's1.foot': '无需代码,对话式配置',
    's2.h3': '一键发布',
    's2.desc': '自动生成智能体对话页和 OpenAI 兼容 API,无需任何部署。',
    's2.foot': '零运维,发布即上线',
    's3.h3': '分享链接',
    's3.desc': '通过智空间个人工具箱展示所有智能体,一个链接分享给任何人。',
    's3.foot': '你的知识,开始为你工作',
    ...
    'f1.label': 'PUBLISH & INTEGRATE',
    'f1.h3': '发布与集成',
    'f1.p': '你的智能体不只是一个对话框,而是可被任何方式使用的能力。',
    'f1.a': '<b>智能体</b>独立对话页面,任何人打开链接就能和你的智能体聊天;支持密码保护、访问统计',
    'f1.b': '<b>OpenAI 兼容 API</b>自动生成标准 API,Cursor、ChatBox 等第三方工具可直接集成你的智能体',
    'f1.foot': '发布即上线,无需任何部署',
    'f2.label': 'PERSONAL BRANDING',
    'f2.h3': '个人品牌',
    'f2.p': '让所有智能体汇聚成你的个人主页,成为独一无二的知识品牌。',
    'f2.a': '<b>智空间</b>个人 AI 工具箱,像 Linktree 一样展示你所有的智能体;自定义主题色、简介、排序',
    ...
    'contact.l1': '<b>立即构建</b>访问 agent.quseit.com,免费创建你的第一个智能体',
    ...
    'dl.action2': '安装与注册指南 <span class="arrow">→</span>',
    ...
    'dl.pl.title': '下载桌面端<br><span class="sec-sub">Windows 与 macOS 已上线 · Linux 正在路上</span>',
    'dl.pl.sub': 'Windows 与 macOS 已上线 · Linux 正在路上',
    'dl.pl.win.h3': 'Windows',
    'dl.pl.win.note': 'Windows 10 / 11 · x64',
    ...
    'dl.pl.mac.h3': 'macOS',
    'dl.pl.mac.note': 'macOS 12+',
    'dl.pl.mac.arm64': 'Apple Silicon 芯片',
    'dl.pl.mac.intel': 'Intel 芯片',
    'dl.pl.mac.howto': '不确定?左上角 苹果菜单 → 关于本机 → 芯片',
    'dl.pl.mac.btn': '下载 .dmg',
    'dl.pl.mac.foot': 'v1.1.0 · 2026-09',
